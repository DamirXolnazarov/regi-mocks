...
<template>
    <div class="candidate">
        ...
        <div class="content relative flex flex-col justify-center items-center w-[100%] p-[15px] pt-[45px]">
            <RouterLink to="/result8" class="absolute left-[15px] top-[15px]">
                <Arrow />
            </RouterLink>
...
export default {
    ...
    data() {
        return {
            candidateDatas: {},
            Sheet_ID: '1ULSy7BnMxRFIis78vRdg40J5uzcFT2Oet5KOle4Jhr8',
            Sheet_TITLE: 'Reg8',
            overall: 0,
            listening: false,
            reading: false,
                ...
                for (let i of data.table.rows) {
                    if (i.c[1].v == this.candidateDatas.Candidate_Name && i.c[2].v == this.candidateDatas.Candidate_ID) {
                        ...
                        this.CandidateResult = {
                            ...
                            ReadingRaw: i.c[4].v,
                            SpeakingRaw: i.c[5].v,
                            WritingTask1Score: i.c[6].v,
                            WritingTask2Score: i.c[7].v,
